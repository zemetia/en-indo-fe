        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/services" className="text-slate-400 hover:text-white transition-colors">Pelayanan</Link></li>
              <li><Link href="/events" className="text-slate-400 hover:text-white transition-colors">Acara</Link></li>
              <li><Link href="/contact" className="text-slate-400 hover:text-white transition-colors">Kontak</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link href="/services/youth" className="text-slate-400 hover:text-white transition-colors">Pelayanan Remaja</Link></li>
              <li><Link href="/services/campus" className="text-slate-400 hover:text-white transition-colors">Pelayanan Kampus</Link></li>
              <li><Link href="/services/lifegroup" className="text-slate-400 hover:text-white transition-colors">Life Groups</Link></li>
              <li><Link href="/services/missions" className="text-slate-400 hover:text-white transition-colors">Misi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm mb-4 text-slate-400">Dapatkan update terbaru dari kami langsung ke email Anda.</p>
            <form className="flex space-x-2">
              <Input type="email" placeholder="Email Anda" className="bg-slate-800 border-slate-700 text-white placeholder:text-slate-400 focus:ring-slate-500" />
              <Button type="submit" className="bg-slate-700 text-white hover:bg-slate-600 transition-colors">Kirim</Button>
            </form>
          </div>
        </div>
      </div>
